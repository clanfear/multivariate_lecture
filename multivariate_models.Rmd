...
```{r, , fig.width=8, fig.height=4, warning=FALSE, message=FALSE, fig.align="center"}
...
```{r, fig.width=8, fig.height=4, message=FALSE, warning=FALSE, fig.align="center"}
plot(precis(m_1))
```
...
.small[
.pull-left[
```{r, fig.width=4, fig.height=3, message=FALSE, warning=FALSE, fig.align="center"}
m_sp_2 <- map(
  alist(
    spur_y ~ dnorm(mu, sigma) ,
...
.smaller[
.pull-left[
```{r, fig.width=5, fig.height=4, message=FALSE, warning=FALSE, fig.align="center", fig.keep='last', results="hide"}
